...
export function buildRowsForHito(
  ...
  if (!hito.incluyeAuditoriasUrl) {
    ...
    rows.push({
      ...
      rankClarity: null,
      url: "(evidencia repo)",
      nombreUi: "Checklist Editorial INAPI v1.1",
      tipoPagina: "—",
      criterioId: "N/A",
      criterioEnunciado: "39 criterios A1–H1 en data/checklist-criteria.json",
      estadoAuditoria: "n/a",
      severidad: "",
      tipoEntrega: "evidencia",
      textoOriginal: "",
      textoPropuesto:
        "Checklist v1.1 operativo en repo + flujo auditoría Claude §17 + validate:claude-audits.",
      motivo: "Evidencia actividad 1 / hito H01 (jun-2026).",
      lineaRef: "",
      htmlLineaAprox: "",
      fragmentoBusqueda: "",
