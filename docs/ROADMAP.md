...
- [x] **Feedback UX — Etapa 4 (cancelada):** ~~sección mock «Calidad web (Sitio Web)» en acordeón aparte~~ — absorbida en tabla única: rank 1 = única URL sitio web con tráfico Clarity; título tarjeta Calidad Web Sitio + Trámites (ver [`docs/ux/inventario-urls-clarity.md`](ux/inventario-urls-clarity.md) §2.1).
