...
**Reglas:** sin solape **494 ↔ 496** (494 = solo Redacción `1.1.5`; 496 = solo Lenguaje plano `1.1.3`). Tarea **504** = solo ARCO. Tareas **510 / 511 / 512** = una pregunta de Contenidos sensibles cada una. En entrega **no** se listan 492/491 salvo **Completitud**.

#### Leyenda Hito ↔ Tarea (dimensión CL1)

| Hito PTD | Tarea PTD |
| --- | --- |
| **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. |
...
| `LC-1.1.2-01` | ¿Los contenidos representan de manera fiel lo enunciado en su título? | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. |
| `LC-1.1.2-02` | ¿Se cumple con la recomendación de no incluir páginas sin contenido, contenido … | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. |
| `LC-1.1.2-03` | ¿El texto destaca los datos clave de la información? Por ejemplo: se presenta u… | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. |
| `LC-1.1.2-04` | En el caso de textos referidos a trámites, ¿se brinda información suficiente pa… | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. |
...
| Completitud `LC-1.1.2-*` | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. |
...
- **Hito:** **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación.
- **Tarea:** **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso.

| # | Id | Pregunta de chequeo | Instrumento | Hito | Tarea | Motor |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | `LC-1.1.2-01` | ¿Los contenidos representan de manera fiel lo enunciado en su título? | Ambos | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. | **E4**, refuerzo A |
| 2 | `LC-1.1.2-02` | ¿Se cumple con la recomendación de no incluir páginas sin contenido, contenido incompleto o «En construcción»? | Ambos | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. | **A6** |
| 3 | `LC-1.1.2-03` | ¿El texto destaca los datos clave de la información? (qué, cómo, dónde, cuándo y para quién, o recuadro con fechas importantes) | Ambos | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. | **A7** (realismo §22.9: cuerpo/recuadros, no labels de menú) |
| 4 | `LC-1.1.2-04` | En textos referidos a trámites, ¿se brinda información suficiente para que las personas usuarias puedan realizarlos autónomamente? («No aplica» si no hay textos de trámites) | Ambos | **492** — La institución cuenta con un checklist editorial obligatorio implementado en su flujo de publicación. | **491** — Implementar un checklist editorial obligatorio para cada publicación que incluya autoría, completitud del contenido, fecha de publicación o actualización, uso de lenguaje claro, corrección ortográfica y gramatical, objetividad en la redacción y uso de lenguaje respetuoso. | **A8** (`no_aplica` en sitioweb informativo) |
