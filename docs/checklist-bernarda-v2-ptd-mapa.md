# Mapa: Checklist Editorial Bernarda PTD v2.0 → motor LC v2.1 (47 criterios)

**Fuente local (no versionada):** `documentos/Checklist_Editorial_INAPI_v2.0.docx` (Bernarda, ago-2026).  
...
1. Explicar a Álvaro / Bernarda / TIC cómo el Word PTD se relaciona con lo que **sí** audita Claude Code hoy.
...
El Excel MEI y la UI ya usan **5 categorías de presentación** Bernarda (Cumple / Cumple con observaciones / Medianamente cumple / No cumple / No aplica) derivadas de `estado` + `severidad`. Eso **no** implica que Usabilidad/Seguridad estén evaluadas.
...
**Decisión MVP 2026:** no añadir ids al motor §17 ni inventar scores de usabilidad en la auditoría LC. Si Álvaro pide “muestra a fin de año”, hacerlo como **anexo cualitativo** o spike aparte, no mezclado con el % de los 47.
...
Si solo hay una lista de correcciones sin (1)–(2), la entrega **no** cumple el estándar pedido en la reunión con Álvaro y Bernarda.

## Relación con Checklist Editorial v2.1 (docx de Fernando)

`documentos/Checklist-Editorial-INAPI-v2-1.docx` es la pauta **operativa del motor** (47 criterios, flujo §17). El Word **v2.0 de Bernarda** es la **vista PTD** (hitos/tareas + tres dimensiones). Ambos conviven:

- v2.1 = qué evalúa Claude Code fila a fila.
- v2.0 Bernarda = cómo se reporta el compromiso MEI/PTD y qué queda para 2027–2028.

## Próximos pasos (no bloquean este mapa)

1. Calibrar 1–2 URLs reauditadas **solo** con §22 (muestra “estándar de oro” para Bernarda).
