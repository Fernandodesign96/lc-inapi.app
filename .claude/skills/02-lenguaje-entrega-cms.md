...
| **Justificación / motivo** | Responde la pregunta del criterio con literales o zona humana. Referencias: «criterio 4», no `LC-*`. **Prohibido:** mapa D0, Prompt N, C-YYYY, Tnnn, códigos IEW/IESD. |
