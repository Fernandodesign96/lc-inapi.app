...
**Documentación de producto / ejemplo humano (rechazado):** [`docs/flujo-piloto-10-urls-claude-mvp.md`](../../docs/flujo-piloto-10-urls-claude-mvp.md) §7 (redirect: `docs/ux/audit-fixture-ejemplo-…`)
