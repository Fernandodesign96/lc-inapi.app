...
export type ClarityInventoryRow = {
  ...
  export const CLARITY_INVENTORY_ROWS: readonly ClarityInventoryRow[] = [
    ...
    { rank: 8, rutaEtiqueta: "`LoadTrademarkApplication` (paso 1)", visitasRef: "37.468", porcentajeLcRef: "—", estadoRef: "No aplica (mock)" },
    ...
    { rank: 15, rutaEtiqueta: "`Account/Register`", visitasRef: "17.603", porcentajeLcRef: "N/A", estadoRef: "No aplica — sin evaluación LC ref." },
    ...
    { rank: 18, rutaEtiqueta: "`EstadosDiariosPatentes`", visitasRef: "12.628", porcentajeLcRef: "N/A", estadoRef: "No aplica (referencia editorial)" },
